...
int HashTable::hash(string s){
   ...
   int power_value = 0;             //power variable
   unsigned int hash_value = 0;     //hash value variable
   ...
   unsigned int index = hash_value % getSize();          //returns unsigned int value so no negatives
   return index;
}